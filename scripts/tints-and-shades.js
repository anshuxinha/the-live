...
function createTintsAndShades(firstTime) {
  ...
  if (parsedColorsArray !== null) {
    ...
    var colorDisplayTable =
      '<table><thead><tr class="table-header"><td><span>0%</span></td><td><span>10%</span></td><td><span>20%</span></td><td><span>30%</span></td><td><span>40%</span></td><td><span>50%</span></td><td><span>60%</span></td><td><span>70%</span></td><td><span>80%</span></td><td><span>90%</span></td><td><span>100%</span></td></tr></thead>' +
    ...
    */
    ...
    $("html,body").animate(
      { scrollTop: $("#ts-scroll-top").offset().top },
      400
    );
